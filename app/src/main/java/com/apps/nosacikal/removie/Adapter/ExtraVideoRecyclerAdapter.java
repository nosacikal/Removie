...
public class ExtraVideoRecyclerAdapter extends RecyclerView.Adapter<MovieVideoViewHolder> {

    private Activity activity;
    private List<MovieVideosResults> movieVideosResultsList;

    public ExtraVideoRecyclerAdapter(Activity activity, List<MovieVideosResults> movieVideosResultsList) {
        ...
        movieVideoViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(activity, movieVideoViewHolder.thumbnailView, ViewCompat.getTransitionName(movieVideoViewHolder.thumbnailView));
