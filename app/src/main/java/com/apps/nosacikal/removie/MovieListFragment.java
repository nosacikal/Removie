...
import com.apps.nosacikal.removie.Adapter.MoviePopularAdapter;
        ...
        movieModelPopularCall.enqueue(new Callback<MovieModel>() {
            ...
            public void onResponse(@NonNull Call<MovieModel> call, @NonNull Response<MovieModel> response) {
                ...
                if (movieModel != null) {
                    ...
                    MoviePopularAdapter moviePopularAdapter = new MoviePopularAdapter(getActivity(), movieModelResultList);
